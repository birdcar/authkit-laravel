...
## [1.0.1](https://github.com/birdcar/authkit-laravel/compare/v1.0.0...v1.0.1) (2026-08-13)

### Bug Fixes

* **auth:** Return the authorization URL string provided by WorkOS PHP SDK v5 instead of reading the removed `url` response key.
* **sdk:** Update renamed WorkOS PHP SDK v5 service method calls for API key validation, organization domains, and Radar attempts.
